    ...
    <>
      ...
      <section>
        <div className="flex items-center justify-between mb-4">
          ...
          <button onClick={() => setCreateOpen(!createOpen)} className="btn">
        ...
        <div className="space-y-3 mt-4">
          {teams.map((t) => (
            <TeamCard key={t.id} team={t} pending={pending} start={start} users={users} priorities={priorities} rankMap={rankMap} />
          ))}
...
function TeamForm({
  ...
  return (
    ...
    >
      ...
      <button disabled={pending || !name.trim()} className="btn btn-primary sm:col-span-2 justify-center">
